...
```
cd existing_repo
git remote add origin https://gitlab.pmcs2i.ec-lyon.fr/ymiled/chess.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.pmcs2i.ec-lyon.fr/ymiled/chess/-/settings/integrations)
